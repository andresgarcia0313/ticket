 ...
 *
 * Descripción larga del archivo (si corresponde) ...
 *
 * PHP version 7
 *
 * LICENCIA: Este archivo fuente está sujeto a la versión de la licencia que 
 * está disponible a través de la red mundial en la URI del proyecto o del 
 * fabricante o al momento de adquirir el software se le brindo una copia. Si no 
 * recibió una copia de la licencia y no puede obtenerla a través de la web, 
 * envíe una solicitud a andresgarcia0313@gmail.com para que podamos enviarle 
 * una copia a la brevedad posible.
 *
 * @category   NombreDeCategoria
 * @package    NombreDePaquete
 * @author     Autor Original <autor@dominio.com>
 * @author     Another Author <otro(a)@dominio.com>
 ...
 * @see        OtraClase, Clase::método()
 * @since      Archivo disponible desde la versión 0.01
 * @deprecated Archivo en desuso en versión 4.0.0
 */
 ...
 */
//define('NOMBRE_DE_CONSTANTE', 1);

// }}}
// {{{ GLOBALS

/**
 * El numero de objetos creados
 * @global int $GLOBALS['EJEMPLO_RECONTEO']
 */
