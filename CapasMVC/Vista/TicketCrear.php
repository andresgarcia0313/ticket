...
<div>
    <h1>Crear Ticket</h1>
    <form name="Crear Ticket" action="../Controlador/LogicaTicket.php" method="POST" target="Crear Ticket">
        ...
        <p><input formmethod="post" type="submit" name="Guardar" value="guardar"></p>
    </form>
</div>
<?php
